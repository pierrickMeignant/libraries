...
import {HttpMethod} from '../models/types/http-method';
import {HttpObserveType} from '../models/types/http-observe-type';
import {HttpResponseType} from '../models/types/http-response-type';
